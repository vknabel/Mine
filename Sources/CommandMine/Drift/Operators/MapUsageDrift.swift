public typealias MapUsageDriftTransformation<Drift: MineType> = (Lore<Drift.Mineral>.Usage) -> Rail<Drift.Mineral>.Usage

fileprivate final class MapUsageDrift<Drift: MineType>: MineType {
